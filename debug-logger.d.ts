...
declare namespace debugLogger {
    ...
    export type Logger = {
         ...
         */
        assert(expression: boolean, message: string, formatArg1: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, formatArg5: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, formatArg5: any, formatArg6: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, formatArg5: any, formatArg6: any, formatArg7: any, level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, formatArg5: any, formatArg6: any, formatArg7: any, formatArg8: any,
               level: string): void;
        assert(expression: boolean, message: string, formatArg1: any, formatArg2: any, formatArg3: any,
               formatArg4: any, formatArg5: any, formatArg6: any, formatArg7: any, formatArg8: any,
               formatArg9: any, level: string): void;
    } & {
        /**
 ...
 */
declare function debugLogger(namespace: string): debugLogger.Logger;
